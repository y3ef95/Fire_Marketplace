# Generated by Django 3.0.14 on 2022-03-24 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trading_location', models.CharField(max_length=50)),
                ...
                ('tag_set', models.ManyToManyField(blank=True, to='contents.Tag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contents.Product')),
            ],
            options={
                'ordering': ['-id'],
            },
